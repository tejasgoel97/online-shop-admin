...
const CategoryScreen = () =>{
    ...
    const {metaData, loading, error, saveBrands, saveCategories } = useMetaData();
    if(loading){
    ...
    return <div>
        ...
        <Category selectedTab={tab} metaData={metaData} saveBrands={saveBrands} saveCategories={saveCategories}/>
    </div>
}
